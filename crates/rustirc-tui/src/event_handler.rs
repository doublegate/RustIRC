    ...
    async fn handle(&self, event: &Event) {
        ...
        match event {
            ...
            Event::MessageReceived {
                ...
                match message.command.as_str() {
                    ...
                    _ => {
                        ...
                        warn!(
                            "TUI: Received unhandled IRC command '{}' - may need implementation",
                            message.command
                        );
                    }
                }
            ...
            Event::NickChanged {
                ...
                info!(
                    "TUI: Nick changed from {} to {} on {}",
                    old, new, connection_id
                );
            ...
            Event::PongRequired {
                ...
                debug!(
                    "TUI: PONG required for connection {} to server {}",
