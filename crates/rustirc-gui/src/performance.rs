...
/// Type alias for update callback function
type UpdateCallback = Box<dyn Fn(&HashMap<String, Vec<DisplayMessage>>) + Send + Sync>;
...
impl MessageBatcher {
    ...
    pub fn should_flush(&self) -> bool {
        ...
        total_messages >= self.batch_size_limit || self.last_update.elapsed() >= self.time_limit
    }
...
impl PerformanceMonitor {
    ...
    pub fn update(&mut self) {
        ...
        self.dirty_tracker
            .cleanup_stale_regions(Duration::from_secs(5));
    }
